/** Icone SVG inline (outline, 24x24) usate al posto delle emoji di interfaccia. */
...
export function TagIcon({ className = "h-4 w-4" }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      <path d="M20 13 13 20a2 2 0 0 1-2.8 0L3.6 13.4A2 2 0 0 1 3 12V5a2 2 0 0 1 2-2h7a2 2 0 0 1 1.4.6L20 10.2a2 2 0 0 1 0 2.8Z" />
